-- ================================================================
-- FIX: employees couldn't see leads. Make the role-check functions
-- SECURITY DEFINER so they can always read the role, and re-assert
-- every staff policy. Supersedes gwe_employee_perms.sql. Idempotent.
-- ================================================================
...
grant execute on function is_mgr()  to authenticated, anon;
...
where tablename in ('leads','call_logs','team_tasks','bids') order by tablename, cmd;
